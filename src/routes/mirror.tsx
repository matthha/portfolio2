import mirror from '../images/JourneyMap.png'
...
export default function Mirror() {
   ...
   <div className="element-content">
      <h1>Mirror Match</h1>
      <div><a type="button" className="btn" href='https://verdant-cell-8ec.notion.site/Mirror-Match-70a30d36bb254905935f71cfe1b112ac' target='blank'>Full Article</a></div>
      ...
      <h3>User Research: </h3>
      <img className="" src={mirror} alt="..." width="800" height="auto" />
